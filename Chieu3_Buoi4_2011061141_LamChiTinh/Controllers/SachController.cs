...
namespace Chieu3_Buoi4_2011061141_LamChiTinh.Controllers
{
    ...
    {
        // GET: Sach
        NhaSachEntities connect = new NhaSachEntities();
        public ActionResult Index()
        {
            List<Sach> listSach = connect.Saches.ToList();
            return View(listSach);
        }
        public ActionResult Detail(int id)
        {
            var D_sach = connect.Saches.Where(m => m.masach == id).First();
            return View(D_sach);
        }
        ...
        {
            var E_sach = connect.Saches.SingleOrDefault(m => m.masach == id);
            return View(E_sach);
        }
        [HttpPost]
        ...
        {
            var D_sach = connect.Saches.First(m => m.masach == id);
            return View(D_sach);
        }
        [HttpPost]
